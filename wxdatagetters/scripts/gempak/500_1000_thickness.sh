...
if( $1 == "" || $2 == "" || $3 == "" || $4 == "") then
    ...
    echo "Usage ./500_1000_thickness.sh  <model>  <time1,time2,...>  <runTime> <MODEL path>"
    exit( 1 )
endif
...
gdplot2_gf << EOF 
  ...
  SKIP   = 0
  SCALE  = 0
  GDPFUN = (sub(hght@500,hght@1000)) ! (sub(hght@500,hght@1000)) ! (sub(hght@500,hght@1000))
  TYPE   = c
  CONTUR = 1
  CINT   = 10/4200/5370 ! 5380;5390;5400 ! 10/5410/6500
