...
def reflect_custom():
	reflect_cdict ={'red':	((0.000, 0.40, 0.40),
		...
		'blue':		((0.000, 0.00, 0.00),
				...
				(0.933, 1.00, 1.00),
				(1.000, 1.00, 1.00))}
	reflect_coltbl = LinearSegmentedColormap('REFLECT_CUSTOM_COLTBL',reflect_cdict)
...
def precip_c():
	...
	precip_c_cdict ={'red':((0.0000, 0.000, 0.000),
				(0.0714, 0.000, 0.000),
				(0.1429, 0.000, 0.000),
				(0.2143, 0.000, 0.000),
				(0.2857, 0.000, 0.000),
		...
		'blue':		((0.0000, 0.925, 0.925),
				...
				(0.9286, 0.788, 0.788),
				(1.000, 0.923, 0.923))}
	precip_c_coltbl = LinearSegmentedColormap('REFLECT_NCDC_COLTBL',precip_c_cdict)
        return precip_c_coltbl
